  ...
  [684],
  {
    ...
    6188: (e, t) => {
      ...
      (Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (window.next = { version: "15.3.3", appDir: !0 }),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
          void 0 === t.default.__esModule &&
          (Object.defineProperty(t.default, "__esModule", { value: !0 }),
      ...
      async function h(e, t) {
        ...
        try {
          ...
          let r = await y(e, c, t, p.signal),
            ...
            O = b.startsWith(n.RSC_CONTENT_TYPE_HEADER);
          if ((O || (O = b.startsWith("text/plain")), !O || !r.ok || !r.body))
        ...
        return M(e, a, t).then(
          async (y) => {
            ...
            if ("string" == typeof T)
              return (
                r(j),
                (0, c.handleExternalUrl)(e, o, T, e.pushRef.pendingPush)
              );
    ...
    9062: (e, t, r) => {
      ...
      function k(e, t) {
        ...
        return (
          n ||
            ((n = e._closed
              ? new O("rejected", null, e._closedReason, e)
              : P(e)),
            r.set(t, n)),
          n
        );
        ...
        ((l[_] = function () {
          ...
          q(e, t, r ? l[_]() : l, {
            enqueueValue: function (t) {
              if (u === n.length)
                n[u] = new O("fulfilled", { done: !1, value: t }, null, e);
              else {
                var r = n[u],
                  o = r.value,
                  l = r.reason;
                    ...
                    switch (((n = a += l.decode(u)), r)) {
                      case 73:
                        ...
                        if ((p = i(_))) {
                          ...
                          y
                            ? x(y, _)
                            : h.set(f, new O("resolved_module", _, null, s));
                        break;
                      case 72:
                        switch (
                          ((t = n[0]),
