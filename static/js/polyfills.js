!(function () {
  ...
  var W = n,
    ...
    dt = function (t) {
      return (
        ut(pt, t) || (pt[t] = H && ut(ht, t) ? ht[t] : vt("Symbol." + t)),
        pt[t]
      );
    },
    gt = TypeError,
    ...
    pc("search", function (t, e, r) {
      return [
        ...
        function (t) {
          ...
          var u = yc(n, o);
          return (
            wa(n.lastIndex, a) || (n.lastIndex = a),
            null === u ? -1 : u.index
          );
        },
      ];
  ...
  var yl = { f: dt },
    ...
    Hl = function (t, e) {
      var r = (Fl[t] = Ve(kl));
      return (
        Rl(r, { type: Ol, tag: t, description: e }),
        u || (r.description = e),
        r
      );
    },
    ...
    Vl = function (t, e) {
      ...
      if (r !== Al || !ut(Fl, n) || ut(Bl, n)) {
        var o = Ll(r, n);
        return (
          !o || !ut(Fl, n) || (ut(r, El) && r[El][n]) || (o.enumerable = !0),
          o
        );
      }
    },
  ...
  if (
    ...
    if (
      ...
      var Pv = function (t) {
        return (
          ko(this, Gp),
          new $p(t, arguments.length > 1 ? Rv(arguments[1]) : {})
        );
      };
      ((Gp.constructor = Pv),
        (Pv.prototype = Gp),
